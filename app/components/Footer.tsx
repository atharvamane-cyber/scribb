      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Scribb</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Explore Scribb</h2>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-orange-500 transition">Articles</a></li>
              <li><a href="#" className="hover:text-orange-500 transition">Blog Posts</a></li>
              <li><a href="#" className="hover:text-orange-500 transition">Guides</a></li>
              <li><a href="#" className="hover:text-orange-500 transition">Interviews</a></li>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="px-4 py-2 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
              />
              <button
                type="submit"
                className="px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-md transition duration-300 ease-in-out transform hover:-translate-y-1 hover:shadow-lg"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-200">
          ...
          <div className="flex items-center space-x-6 text-sm">
            <a href="#" className="text-gray-500 hover:text-orange-500 transition">English</a>
            <a href="#" className="text-gray-500 hover:text-orange-500 transition">₹ INR</a>
            <a href="#" className="text-gray-500 hover:text-orange-500 transition">Accessibility</a>
          </div>
        </div>
      </div>
    </footer>
